...
class SquareTest {
    ...
    void testToString() {
        ...
        assertEquals("Square[Rectangle[Shape[color=red,filled=true],width=1.0,length=1.0]]", s1.toString());
        assertDoesNotThrow(() -> s2.toString());
        assertEquals("Square[Rectangle[Shape[color=red,filled=true],width=2.0,length=2.0]]", s2.toString());
        assertDoesNotThrow(() -> s3.toString());
        assertEquals("Square[Rectangle[Shape[color=blue,filled=false],width=3.0,length=3.0]]", s3.toString());
    }
}